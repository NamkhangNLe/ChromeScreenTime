...
function App() {
    ...
    var keyValuePairsMap = new Map(keyValuePairs);
    var categoryData = {};
    Object.entries(urls).forEach(function (_a) {
        var url = _a[0], timeSpent = _a[1];
        var category = keyValuePairsMap.get(url) || "Other";
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("h1", null, "Chrome Screen Time"),
        React.createElement("div", { className: "chart-container" },
            React.createElement(Doughnut, { data: data })),
        React.createElement("div", { className: "chart-container" },
            React.createElement(Bar, { data: dataCategories })),
        React.createElement("div", { className: "card" },
            React.createElement("button", { onClick: newTab }, "Calendar View"),
            React.createElement("h2", null, "URLs Hashmap Contents:"),
            React.createElement("ul", null, Object.entries(urls).map(function (_a) {
                var url = _a[0], timeSpent = _a[1];
